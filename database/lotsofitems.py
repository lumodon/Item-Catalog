...
if __name__ == '__main__':
    ...
    item4 = Item(name="Choc Full O\' Mint (Smitten\'s Fresh Mint Chip ice cream)",
                        description="Milk, cream, salt, ..., Liquid nitrogen magic", owner_id="initial_user", category=category1)
